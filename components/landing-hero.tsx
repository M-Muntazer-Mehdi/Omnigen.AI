...
export const LandingHero = () => {
  ...
  return (
    <div className="text-black font-bold py-16 text-center space-y-5">
      <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl space-y-5 font-extrabold">
        <h1>The Best AI Tool for</h1>
<div className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-500 to-black">
  <TypewriterComponent
    options={{
  ...
  <Link href={isSignedIn ? "/dashboard" : "/sign-up"}>
    <Button
      ...
      className="md:text-lg p-4 md:p-6 rounded-full font-semibold
                 bg-gradient-radial from-gray-500 via-gray-900 to-black
                 text-white"
    >
